...
execute if entity @s[tag=towcit.hide_display.temp] run tellraw @s {"text":"Enabled Village Name Display","italic":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger village_name_display"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to toggle","italic":true,"color":"gray"}]}}
...
execute unless entity @s[tag=towcit.hide_display.temp] run tellraw @s {"text":"Disabled Village Name Display","italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger village_name_display"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to toggle","italic":true,"color":"gray"}]}}
